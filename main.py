...
class TextCreator:
    ...
    def get_review(self, document: Document) -> Document:
    ...
    @retry(wait=wait_chain(*[wait_fixed(10) for i in range(6)]))
    def get_information(self, document: Document) -> Document:
    ...
    @retry(wait=wait_chain(*[wait_fixed(10) for i in range(6)]))
    def get_rtp(self, document: Document) -> Document:
    ...
    @retry(wait=wait_chain(*[wait_fixed(10) for i in range(6)]))
    def get_symbols_and_combinations(self, document: Document) -> Document:
    ...
    @retry(wait=wait_chain(*[wait_fixed(10) for i in range(6)]))
    def get_jackpot(self, document: Document) -> Document:
    ...
    @retry(wait=wait_chain(*[wait_fixed(10) for i in range(6)]))
    def get_mobile_play(self, document: Document) -> Document:
    ...
    @retry(wait=wait_chain(*[wait_fixed(10) for i in range(6)]))
    def get_pros_and_cons(self, document: Document) -> Document:
    ...
    @retry(wait=wait_chain(*[wait_fixed(10) for i in range(6)]))
    def get_faq(self, document: Document) -> Document:
